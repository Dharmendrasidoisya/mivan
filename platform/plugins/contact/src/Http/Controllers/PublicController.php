...
class PublicController extends BaseController
{
    public function postSendContact(ContactRequest $request)
    {
        ...
        try {
            ...
            // Reply-To (so support team can reply to the sender)
            $args = [];
            ...
            // ✅ Add BCC recipients
            $bccRecipients = [
                'dharmendrasinh@indiantradebird.com',
                'jitendra@goadsindia.co.in',
            ];
            ...
            EmailHandler::setModule(CONTACT_MODULE_SCREEN_NAME)
                ...
                ->sendUsingTemplate(
                    'notice',
                    'support@mivandholera.com',
                    array_merge($args, ['bcc' => $bccRecipients])
                );
