...
<div class="mb-3">
    ...
    <textarea name="history" class="form-control" rows="5" placeholder="History">{{ Arr::get($attributes, 'history') }}</textarea>
</div>
<div class="mb-3">
    <label class="form-label">{{ __('History') }}</label>
    <textarea name="history2" class="form-control" rows="5" placeholder="History">{{ Arr::get($attributes, 'history2') }}</textarea>
</div>
<div class="mb-3">
    <label class="form-label">{{ __('Mission') }}</label>
    <textarea name="mission" class="form-control" rows="5" placeholder="Mission">{{ Arr::get($attributes, 'mission') }}</textarea>
</div>
<div class="mb-3">
    <label class="form-label">{{ __('Vision') }}</label>
    <textarea name="vision" class="form-control" rows="5" placeholder="Vision">{{ Arr::get($attributes, 'vision') }}</textarea>
</div>
<div class="mb-3">
