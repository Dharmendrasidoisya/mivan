            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-12">
                    <div class="ul-project-status-legend"
                        style="margin-bottom: 20px; display: flex; gap: 15px; font-family: sans-serif;     overflow: auto;">
                      <div
        ...
        tds.forEach(td => {
            ...
            if (d && d.plot_status) {
                ...
                if (status === 'available') {
                    ...
                    td.style.backgroundColor = '#E31E24';
                    td.style.color = '#fff';
                } else if (status === 'hold') {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('#plotTableBody td').forEach(td => {
            td.addEventListener('mouseenter', function(e) {
                ...
                if (d?.plot_status) {
                    const status = d.plot_status.toLowerCase();
                    if (status === 'booked') statusColor = '#E31E24';
                    else if (status === 'hold') statusColor = '#F1C40F';
