...
app()->booted(function () {
    ...
    // if (is_plugin_active('ecommerce')) {
        ...
        shortcode()->setAdminConfig('Ads-about-us', function (array $attributes) {
            ...
            __('Ads About-dholera'),
            function (Shortcode $shortcode) {
                return Theme::partial('shortcodes.Ads-about-dholera', [
                    'title' => $shortcode->title,
                    'headertitle' => $shortcode->headertitle,
                    'description' => $shortcode->description,
                    'icon' => $shortcode->icon, // Include the image attribute
        ...
        shortcode()->setAdminConfig('Ads-about-dholera', function (array $attributes) {
            return Theme::partial('shortcodes.Ads-about-dholera-us-admin-config', compact('attributes'));
        });
