...
class FilterPostTest extends TestCase
{
    public function test_it_returns_default_filters_for_an_empty_request(): void
    {
        $this->assertSame([
            ...
            'projectscategories' => null,
            'projectscategories_exclude' => null,
            'projectstags' => null,
            'projectstags_exclude' => null,
            'featured' => null,
    ...
    public function test_it_keeps_provided_values(): void
    {
        $filters = FilterPost::setFilters([
            ...
            'order' => 'asc',
            'order_by' => 'created_at',
            'projectscategories' => [4],
            'projectscategories_exclude' => [5],
            'projectstags' => [6],
            'projectstags_exclude' => [9],
            'featured' => true,
        ]);
        ...
        $this->assertSame([4], $filters['projectscategories']);
        $this->assertSame([5], $filters['projectscategories_exclude']);
        $this->assertSame([6], $filters['projectstags']);
        $this->assertSame([9], $filters['projectstags_exclude']);
